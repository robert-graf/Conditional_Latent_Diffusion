...
class NoisyLatentImageClassifier(pl.LightningModule):
    ...
    def load_classifier(self, ckpt_path, pool):
        ...
        self.model = __models__[self.label_key](**model_config)  # type: ignore
    ...
    def forward(self, x_noisy, t, *_args, **_kwargs):
    ...
    @torch.no_grad()
    def log_images(self, batch, N=8, *_args, **_kwargs):
        log = {}
